    ...
    <div className="flex h-full w-full bg-slate-100 overflow-hidden">
      ...
      >
        <div className="flex flex-col h-full p-4">
          <h2 className="text-xl font-bold mb-8 text-emerald-400">Financiera</h2>
      ...
      <div className="flex flex-col flex-1 h-full">
        ...
        <header className="md:hidden bg-white shadow px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-slate-800">Panel Financiero</h1>
          </div>
            ...
            <div className="relative">
              ...
              {openUserMenu && (
                <div className="absolute right-0 mt-2 w-36 bg-white rounded-lg shadow-lg border z-50">
                  <button
                    onClick={logout}
                    className="w-full text-left px-4 py-2 text-sm hover:bg-slate-100 rounded-lg"
                  >
                    Cerrar sesión
                  </button>
                </div>
